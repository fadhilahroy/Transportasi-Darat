...
public class mobil {
    ...
    private String Ford;
    private String BMW;
    private String Porche;
    private String Aston_Martin;
    ...
    public String getPorche() {
        return Porche;
    }

    public void setPorche(String Porche) {
        this.Porche = Porche;
    }

    public String getAston_Martin() {
        return Aston_Martin;
    }

    public void setAston_Martin(String Aston_Martin) {
        this.Aston_Martin = Aston_Martin;
    }
